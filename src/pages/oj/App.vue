  ...
  <div id="app">
    ...
    <div class="content-app theme1">
      ...
      <div class="footer">
        ...
        <p>Modified by <a href="https://jefery.ga/">Jefery</a></p>
        <p>Powered by <a href="https://github.com/Goldbeibei">OnlineJudge</a>&nbsp; <span v-if="version">Version: 20230126 v2.0</span></p>
      </div>
    </div>
	<BackTop></BackTop>
  </div>
